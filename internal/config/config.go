...
// Load reads configuration from the environment. Unknown/missing required
// values are fatal so a mis-configured cron run fails fast instead of
// half-running against the wrong state.
